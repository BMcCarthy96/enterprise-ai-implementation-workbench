  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        ...
        subtitle={isInternal ? "A recruiter-ready view of delivery health, governance, and AI evidence." : "Your implementation projects at a glance."}
      />
      ...
      <div className="grid gap-6 xl:grid-cols-5">
        ...
        {isInternal && <section className="card overflow-hidden xl:col-span-2" aria-labelledby="ai-proof-heading">
          <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3"><div><h2 id="ai-proof-heading" className="text-sm font-semibold text-slate-950">AI proof</h2><p className="mt-0.5 text-xs text-slate-500">Observable quality signals from recorded plan runs.</p></div><span className="rounded-full bg-cyan-50 px-2 py-1 text-[10px] font-semibold uppercase tracking-wide text-cyan-700">No fake trends</span></div>
